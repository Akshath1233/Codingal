...
def apply_color_filter(image, filter_type, intensity=50):
    ...
    if filter_type == "red_tint":
        ...
        filtered_image[:,:,2] =cv2.add(filtered_image[:,:,2], intensity) # Decrease red channel
...
interactive_color_filter('C:\\Users\\Aksha\\OneDrive\\Desktop\\Random stuff 2\\Legion wallpapers\\Wallpaper legion.png')