...
try:
    ...
    interface = devices.Activate(IAudioEndpointVolume ._ iid_, CLSCTX_ALL, None)
...
while True:
    ...
    if results.multi_hand_landmarks and results.multihandedness:
        for i, handLms in enumerate(results.multi_hand_landmarks):
            ...
            if label == "Right": # Volume control with right hand
                vol = np.interp(dist, [30, 300], [min_vbl, max_vol])
                try:
